...
void Ui::handle_r_key(Table& table) {
    if (game_state == GameState::WAIT_FOR_RESTART) {
        table.init();
        game_state = GameState::GAME;
    }
}
void Ui::handle_q_key(Table&) {
